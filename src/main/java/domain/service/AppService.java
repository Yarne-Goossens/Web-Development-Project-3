...
public class AppService {
    private final UserServiceDBSQL userDB = new UserServiceDBSQL();
    private final ProjectServiceDBSQL projectDB = new ProjectServiceDBSQL();
    private final WorkorderServiceDBSQL workorderDB = new WorkorderServiceDBSQL();
